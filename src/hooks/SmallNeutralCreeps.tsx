...
import ancient from "../assets/structures/ancient.png"
import melee_barracks from "../assets/structures/melee_barracks.png"
import renget_barracks from "../assets/structures/renget_barracks.png"
import tier_1_tower from "../assets/structures/tier_1_tower.png"
import tier_2_3_tower from "../assets/structures/tier_2-3_tower.png"
import tier_4_tower from "../assets/structures/tier_4_tower.png"
...
const Structures: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setLoading(true);
            try {
                const response = await axios.get<Item[]>('http://127.0.0.1:8000/smallneutralcamps/');
